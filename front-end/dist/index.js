...
;// CONCATENATED MODULE: ./src/modules/view-app.js


function createElementFormLogin() {
  var containerForm = el('div', {
    "class": 'container-form'
  });
  var blockForm = el('div', {
    "class": 'block-form'
  });
  var title = el('h1', 'Вход в аккаунт', {
    "class": 'title-form'
  });
  var form = el('form', {
    "class": 'form-entry'
...
function createElementAccountsPage(arrayAccounts) {
  var skelet = skeletonAccountsPage();
  ...
  function createElListAcc(arrayAccounts) {
    var arrayAccountsHelp = [];
    arrayAccounts.payload.forEach(function (item) {
      console.log(item);
      var date = null;
  ...
  return {
    createElListAcc: createElListAcc
  };
}
function createElementATMsPage(arrayAtms) {
  var skelet = skeletonATMsPage();
  skelet.title.textContent = 'Карта банкоматов';
  skelet.title.classList.remove('atms__title_skeleton');
  var scriptInit = el('script', {
    type: 'text/javascript',
    defer: true
  });
  document.head.prepend(scriptInit);
  var data = "\n  // \u0424\u0443\u043D\u043A\u0446\u0438\u044F ymaps.ready() \u0431\u0443\u0434\u0435\u0442 \u0432\u044B\u0437\u0432\u0430\u043D\u0430, \u043A\u043E\u0433\u0434\u0430\n  // \u0437\u0430\u0433\u0440\u0443\u0437\u044F\u0442\u0441\u044F \u0432\u0441\u0435 \u043A\u043E\u043C\u043F\u043E\u043D\u0435\u043D\u0442\u044B API, \u0430 \u0442\u0430\u043A\u0436\u0435 \u043A\u043E\u0433\u0434\u0430 \u0431\u0443\u0434\u0435\u0442 \u0433\u043E\u0442\u043E\u0432\u043E DOM-\u0434\u0435\u0440\u0435\u0432\u043E.\n  ymaps.ready(init);\n  function init(){\n      // \u0421\u043E\u0437\u0434\u0430\u043D\u0438\u0435 \u043A\u0430\u0440\u0442\u044B.\n      var myMap = new ymaps.Map(\"map\", {\n          // \u041A\u043E\u043E\u0440\u0434\u0438\u043D\u0430\u0442\u044B \u0446\u0435\u043D\u0442\u0440\u0430 \u043A\u0430\u0440\u0442\u044B.\n          // \u041F\u043E\u0440\u044F\u0434\u043E\u043A \u043F\u043E \u0443\u043C\u043E\u043B\u0447\u0430\u043D\u0438\u044E: \xAB\u0448\u0438\u0440\u043E\u0442\u0430, \u0434\u043E\u043B\u0433\u043E\u0442\u0430\xBB.\n          // \u0427\u0442\u043E\u0431\u044B \u043D\u0435 \u043E\u043F\u0440\u0435\u0434\u0435\u043B\u044F\u0442\u044C \u043A\u043E\u043E\u0440\u0434\u0438\u043D\u0430\u0442\u044B \u0446\u0435\u043D\u0442\u0440\u0430 \u043A\u0430\u0440\u0442\u044B \u0432\u0440\u0443\u0447\u043D\u0443\u044E,\n          // \u0432\u043E\u0441\u043F\u043E\u043B\u044C\u0437\u0443\u0439\u0442\u0435\u0441\u044C \u0438\u043D\u0441\u0442\u0440\u0443\u043C\u0435\u043D\u0442\u043E\u043C \u041E\u043F\u0440\u0435\u0434\u0435\u043B\u0435\u043D\u0438\u0435 \u043A\u043E\u043E\u0440\u0434\u0438\u043D\u0430\u0442.\n          center: [55.76, 37.64],\n          // \u0423\u0440\u043E\u0432\u0435\u043D\u044C \u043C\u0430\u0441\u0448\u0442\u0430\u0431\u0438\u0440\u043E\u0432\u0430\u043D\u0438\u044F. \u0414\u043E\u043F\u0443\u0441\u0442\u0438\u043C\u044B\u0435 \u0437\u043D\u0430\u0447\u0435\u043D\u0438\u044F:\n          // \u043E\u0442 0 (\u0432\u0435\u0441\u044C \u043C\u0438\u0440) \u0434\u043E 19.\n          zoom: 11,\n      });\n      myMap.behaviors\n    // \u041E\u0442\u043A\u043B\u044E\u0447\u0430\u0435\u043C \u043D\u0435\u043A\u043E\u0442\u043E\u0440\u044B\u0435 \u0432\u043A\u043B\u044E\u0447\u0435\u043D\u043D\u044B\u0435 \u043F\u043E \u0443\u043C\u043E\u043B\u0447\u0430\u043D\u0438\u044E \u043F\u043E\u0432\u0435\u0434\u0435\u043D\u0438\u044F:\n    // - drag - \u043F\u0435\u0440\u0435\u043C\u0435\u0449\u0435\u043D\u0438\u0435 \u043A\u0430\u0440\u0442\u044B \u043F\u0440\u0438 \u043D\u0430\u0436\u0430\u0442\u043E\u0439 \u043B\u0435\u0432\u043E\u0439 \u043A\u043D\u043E\u043F\u043A\u0438 \u043C\u044B\u0448\u0438;\n    // - rightMouseButtonMagnifier - \u0443\u0432\u0435\u043B\u0438\u0447\u0435\u043D\u0438\u0435 \u043E\u0431\u043B\u0430\u0441\u0442\u0438, \u0432\u044B\u0434\u0435\u043B\u0435\u043D\u043D\u043E\u0439\n    // \u043F\u0440\u0430\u0432\u043E\u0439 \u043A\u043D\u043E\u043F\u043A\u043E\u0439 \u043C\u044B\u0448\u0438.\n    .disable(['scrollZoom']);\n  ";
  arrayAtms.forEach(function (el, index) {
    var objPoint = "\n    var myPlacemark".concat(index, " = new ymaps.Placemark([").concat(el.lat, ", ").concat(el.lon, "]);\n    myMap.geoObjects.add(myPlacemark").concat(index, ");\n  ");
    data = data + objPoint;
  });
...
function createElementCurrencyPage() {
  var currencyAccount = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
  var arrayCurrency = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
  var status = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
  var skelet = skeletonCurrencyPage();
...
function createElListCurrency(array) {
...
function createElementAccPage() {
  ...
  var skelet = skeletonAccPage();
  var listNum = [];

  if (localStorage.getItem('numTranc')) {
    var list = JSON.parse(localStorage.getItem('numTranc'));
  ...
  if (status) {
    var arrayElTable = createElTableTransaction(account, 11);
    setChildren(skelet.contTitleAndNumber, el('h1', 'Просмотр счёта', {
      "class": 'acc__title'
    }), el('span', "\u2116 ".concat(account.account), {
      "class": 'acc__number'
    }));
  ...
  document.querySelector('.form-transfer__input-num').addEventListener('focus', function () {
    elListNum.classList.add('list-active');
  });
  document.querySelector('.form-transfer__input-num').addEventListener('blur', function (e) {
    setTimeout(function () {
      elListNum.classList.remove('list-active');
    }, 100);
  });
  document.querySelector('.list-num-tranc').addEventListener('click', function (i) {
...
function createElementAccPageHistoryTranc() {
  var account = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
  var status = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;

  if (!status) {
    createElementAccPage();
    var skelet = skeletonAccPageHistoryTranc();
    ...
    var numBtn = function numBtn(i, r) {
      var arrayBtnControl = [];
      ...
      var _loop = function _loop() {
        ...
        x.addEventListener('click', function () {
          var num = x.textContent * 25;
          var arrayElTable = createElTableTransaction(account, 26, num);
          var table = document.querySelector('.table-transaction');
          var elTable = el('tbody', {
            "class": 'table-transaction__body'
          }, el('tr', {
            "class": 'table-transaction__heading'
          }, el('td', 'Счёт отправителя', {
    ...
    var _skelet = skeletonAccPageHistoryTranc();

    var arrayElTable = createElTableTransaction(account, 26, 0);
    var countListElTable = account.transactions.length / 25;
    var i = 1;
    var r = 10;
    var arrayBtnControl = numBtn(1, 10);
    setChildren(_skelet.graphDinamicBalance, el('h2', 'Динамика баланса', {
      "class": 'acc__title-cont'
    }), el('canvas', {
      "class": 'graph-dinamic-balance',
      id: 'graph-dinamic-balance'
    }));
    setChildren(_skelet.graphDinamicTransaction, el('h2', 'Соотношение входящих исходящих транзакций', {
      "class": 'acc__title-cont'
    }), el('canvas', {
      "class": 'graph-dinamic-transaction',
      id: 'graph-dinamic-transaction'
    }));
    setChildren(_skelet.contHistoryTransaction, el('h2', 'История переводов', {
      "class": 'acc__title-cont'
    }), el('table', {
    ...
    document.querySelector('.table-control-btn-onward').addEventListener('click', function () {
      var contBtn = document.querySelector('.acc__container-control');
      document.querySelectorAll('.table-control-btn').forEach(function (elem, index) {
...
;
function createElementExchangeOnline(arrayEx) {
  var list = el('list', {
    "class": 'list-exchange'
  });
  arrayEx.forEach(function (i) {
    var classNameLine = null;
    ...
    var item = el('li', {
      ...
      "class": "list-exchange__line ".concat(classNameLine)
    }), el('span', i.rate, {
      "class": "list-exchange__value ".concat(classNameValue)
    }));
    list.append(item);
  });
...
function createCustomSelect(title, arrayItem, id) {
  ...
  arrayElement.forEach(function (el) {
    el.addEventListener('click', function () {
      var selectId = document.querySelector("#".concat(id));
...
function createGraph(id, array, mon) {
  ...
  var arrayMonthName = ['Январь', 'Февраль', 'Март', 'Апрель', 'Май', 'Июнь', 'Июль', 'Август', 'Сентябрь', 'Октябрь', 'Ноябрь', 'Декабрь'];
  ...
  for (var i = 0; i < mon; i++) {
    ...
    if (flag) {
      for (var _i = 0; _i < array.length; _i++) {
        if (numMonth + 1 === Number(array[_i].name.substr(4, 2))) {
          profitMonth.push(array[_i].toCash);
          fromCashArray.push(array[_i].fromCash);
          numMonth++;
          result = true;
          break;
        }
      ...
      for (var _i2 = 0; _i2 < array.length; _i2++) {
        if (numMonth + 1 === Number(array[_i2].name.substr(4, 2))) {
          profit += array[_i2].profit;
          console.log(profit);
  ...
  var myChart = new auto_esm(ctx, config);
}

function createElTableTransaction(array, num) {
  ...
  if (array.transactions.length != 0) {
    for (var i = 1; i <= num; i++) {
      var element = array.transactions[array.transactions.length - x - i];
      var statusTransaction = null;
      var amount = null;
      ...
      if (element.from != array.account) {
        ...
        amount = "+ ".concat(element.amount, " \u20BD");
      } else {
        statusTransaction = 'table-transaction__item_red';
        amount = "- ".concat(element.amount, " \u20BD");
      }

      var elementTable = el('tr', {
        ...
        "class": "table-transaction__item ".concat(statusTransaction)
      }), el('td', "".concat(day, ".").concat(month, ".").concat(year), {
        "class": 'table-transaction__item'
      }));
...
function skeletonAccPage() {
  ...
  var contAndFormTransfer = el('div', {
  ...
  var contHistoryTransaction = el('div', {
  ...
  var containerBottom = el('div', {
    "class": 'container-bottom'
  }, contHistoryTransaction);
  var containerMiddle = el('div', {
  ...
  setChildren(document.querySelector('main'), container);
  return {
    contTitleAndNumber: contTitleAndNumber,
    contBtnAndBalance: contBtnAndBalance,
    contAndFormTransfer: contAndFormTransfer,
    contDinamicBalance: contDinamicBalance,
    contHistoryTransaction: contHistoryTransaction
  };
}

function skeletonAccPageHistoryTranc() {
  var graphDinamicBalance = el('div', {
  ...
  var graphDinamicTransaction = el('div', {
  ...
  var contMiddle = document.querySelector('.container-middle');
  var contBottom = document.querySelector('.container-bottom');
  ...
  return {
    graphDinamicBalance: graphDinamicBalance,
    graphDinamicTransaction: graphDinamicTransaction,
    contHistoryTransaction: contHistoryTransaction
  };
}
...
function skeletonCurrencyPage() {
  ...
  var elFormTradeCurrency = el('div', {
  ...
  return {
    ...
    elCurrencyAccount: elCurrencyAccount,
    formTrade: formTrade,
    elFormTradeCurrency: elFormTradeCurrency
  };
}
...
function createModalErrorRoot() {
  var contModal = el('div', {
...
function validateFormTransaction(id) {
  var form = document.querySelector('.from-transfer');
  var num = form.querySelector('.form-transfer__input-num');
  var value = form.querySelector('.form-transfer__input-value');
  var btn = form.querySelector('.btn');
  var error = document.querySelector('.form-transfer-errors');
  var valueBalance = document.querySelector('.acc__balance-value').textContent;
  var flag = false;
  var numData = '';
  var valueData = '';
  num.addEventListener('input', function (i) {
  ...
  value.addEventListener('input', function (i) {
    if (num.value && value.value) {
      btn.disabled = false;
    } else {
      btn.disabled = true;
...
function validationFormCyrrency() {
  var form = document.querySelector('.currency-trade__form');
  var value = form.querySelector('.currency-trade__value');
  var btn = form.querySelector('.btn');
  var valueData = '';
  value.addEventListener('input', function (i) {
    if (i.inputType != 'deleteContentBackward') {
...
function validationFormLogin() {
  ...
  var errorText = document.querySelector('.login-error');
...
;// CONCATENATED MODULE: ./src/modules/api-app.js
...
function loginApp() {
  return _loginApp.apply(this, arguments);
}

function _loginApp() {
  _loginApp = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            ...
            return _context.abrupt("return", result.payload.token);
...
function _getAccounts() {
  _getAccounts = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(token) {
...
function _createAccount() {
  _createAccount = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(token) {
    var result;
...
function getAtmBanks(_x3) {
  return _getAtmBanks.apply(this, arguments);
}

function _getAtmBanks() {
  _getAtmBanks = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(token) {
...
function getCurrencyAccount(_x4) {
  return _getCurrencyAccount.apply(this, arguments);
}

function _getCurrencyAccount() {
  _getCurrencyAccount = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(token) {
    var result, resultArray, key;
...
function getAllCurrency(_x5) {
  return _getAllCurrency.apply(this, arguments);
}

function _getAllCurrency() {
  _getAllCurrency = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(token) {
    var result;
    return regeneratorRuntime.wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 6:
            result = _context8.sent;
            return _context8.abrupt("return", result.payload);
...
function getExchangeWebSocket() {
  return _getExchangeWebSocket.apply(this, arguments);
}

function _getExchangeWebSocket() {
  _getExchangeWebSocket = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10() {
    var soccet, arrayCurrency;
    return regeneratorRuntime.wrap(function _callee10$(_context10) {
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            _context10.prev = 0;
            soccet = new WebSocket('ws://localhost:3000/currency-feed');
            arrayCurrency = [];

            soccet.onopen = function (e) {};

            soccet.onmessage = /*#__PURE__*/function () {
              var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(el) {
                var message;
                return regeneratorRuntime.wrap(function _callee9$(_context9) {
                  while (1) {
                    switch (_context9.prev = _context9.next) {
                      case 0:
                        message = JSON.parse(el.data);
            ...
            return _context10.abrupt("return", soccet);
...
function getInformCard(_x6, _x7) {
  return _getInformCard.apply(this, arguments);
}

function _getInformCard() {
  _getInformCard = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12(id, token) {
    return regeneratorRuntime.wrap(function _callee12$(_context12) {
      while (1) {
        switch (_context12.prev = _context12.next) {
          case 0:
            return _context12.abrupt("return", new Promise( /*#__PURE__*/function () {
              var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(resolve, reject) {
                  ...
                  while (1) {
                    switch (_context11.prev = _context11.next) {
                      ...
                      case 6:
                        result = _context11.sent;
                        _context11.next = 9;
                        return processingArrayTransaction(result.payload.transactions, id);

                      case 9:
                        resultTransaction = _context11.sent;
...
function postTransaction(id, token) {
  try {
    var form = document.querySelector('.from-transfer');
...
function postCurrencyExchange(token) {
  try {
    var form = document.querySelector('.currency-trade__form');
    validationFormCyrrency();
    form.addEventListener('submit', function (i) {
      i.preventDefault();
      var from = form.querySelector('#select-formTrade-out').querySelector('.select__none');
      var to = form.querySelector('#select-formTrade-in').querySelector('.select__none');
      var value = form.querySelector('.currency-trade__value');
...
function processingArrayTransaction(_x8, _x9) {
  return _processingArrayTransaction.apply(this, arguments);
}

function _processingArrayTransaction() {
  _processingArrayTransaction = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee13(array, id) {
    var resultArray;
          ...
          case 0:
            ...
            array.forEach(function (el) {
              ...
              if (!resultArray[key]) {
                ...
                var profit = toCash - fromCash;
                resultArray[key].profit += profit;
              }
            });
            return _context13.abrupt("return", resultArray);
...
const logo_namespaceObject = __webpack_require__.p + "818296a801a20d53246f.png";
...
var id = localStorage.getItem('idAcc');
var objTranc;
/*Запуск функций*/

src_createElement();
createModalErrorRoot();
var src_router = new (navigo_min_default())('/');
src_router.on('/', /*#__PURE__*/src_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
  return regeneratorRuntime.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
...
}))).on('/account', /*#__PURE__*/src_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
  var create;
  return regeneratorRuntime.wrap(function _callee2$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          create = createElementAccountsPage(arrayAccounts);
          getAccounts(token).then(function (res) {
            arrayAccounts = res;
  ...
  createElementHeader(true);
  getAtmBanks(token).then(function (res) {
    createElementATMsPage(res);
    routerApp();
  })["catch"](function (err) {
    openModalError(err);
  });
}).on('/currency', function () {
  createElementHeader(true);
  routerApp();
  var arrayCurrencyAccount = null;
  var arrayCurrency = null;
  createElementCurrencyPage();
  Promise.all([getCurrencyAccount(token), getAllCurrency(token)]).then(function (value) {
  ...
  createElementHeader(true);
  createElementAccPage();
  getInformCard(id, token).then(function (res) {
    var arrayMonth = [];
    objTranc = res.resultTransaction;

    for (var key in objTranc) {
      var date = new Date();
      var year = date.getFullYear();
      var month = date.getMonth();
      ...
      var twoDate = String(year) + String(month);
    ...
    routerApp();
    document.querySelector('.acc__btn-back').addEventListener('click', function () {
      src_router.navigate('/account');
    });
    document.querySelector('.acc__container-dinamic-balance').addEventListener('click', function () {
      src_router.navigate('/card-history-transaction');
    });
    document.querySelector('.container-bottom').addEventListener('click', function () {
      src_router.navigate('/card-history-transaction');
    });
  })["catch"](function (err) {
    openModalError(err);
  });
}).on('/card-history-transaction', function () {
  createElementHeader(true);
  ...
  getInformCard(id, token).then(function (res) {
    ...
    for (var key in objTranc) {
      ...
      var year = date.getFullYear();
      var month = date.getMonth();
      var twoDate = String(year - 1) + '0' + String(month + 2);
    ...
    routerApp();
    document.querySelector('.acc__btn-back').addEventListener('click', function () {
      src_router.navigate('/card');
    });
  });
});
src_router.resolve();

function src_createElement() {
  var container = el('div', {
    "class": 'container'
  });
  main = el('main', {
  ...
  var header = createElementHeader();
  setChildren(main, container);
  setChildren(document.body, [header, main]);
}

function createElementHeader() {
  var login = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
...
function login() {
  var form = document.querySelector('.form-entry');
  var btnLogin = document.querySelector('.form-entry__btn');
  btnLogin.addEventListener('click', /*#__PURE__*/src_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
...
function routerApp() {
  document.querySelectorAll('.menu__link').forEach(function (el) {
    el.addEventListener('click', function (i) {
      i.preventDefault();
      src_router.navigate(i.target.getAttribute('href'));
    });
  });
  document.querySelectorAll('.account').forEach(function (el) {
    el.querySelector('.account__btn').addEventListener('click', function () {
...
function addAccountControlBtn() {
  document.querySelector('.accounts__btn-add').addEventListener('click', /*#__PURE__*/src_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
    var create;
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
...
function sortAccounts(array) {
  ...
  document.querySelector('.select').addEventListener('click', function (e) {
    ...
    if (e.target.textContent === 'По последней транзакции') {
      array.payload.forEach(function (el) {
